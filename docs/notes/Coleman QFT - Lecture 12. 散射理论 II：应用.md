...
>
> $$
> \mathrm{d}\sigma=\dfrac{1}{4E_1E_2}\dfrac{1}{|\vec v_1-\vec v_2|}|\mathcal A_{fi}|^2D=\dfrac{1}{4E_T|\vec p_i|}|\mathcal A_{fi}|^2\dfrac{1}{16\pi^2}\dfrac{|\vec p_f|\,\mathrm{d}\varOmega_f}{E_T}
> $$
>
> 最终整理得到：
>
